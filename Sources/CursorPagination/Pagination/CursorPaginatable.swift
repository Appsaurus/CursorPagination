...
//	public static func paginate<CR: CursorPaginationSortResolvable>(request: Request, sorts: CR...) throws -> Future<CursorPage<Self>> where CR.M == Self {
//		let sorts = try sorts.map({try $0.toCursorPaginationSort()})
//		return try paginate(request: request, sorts: sorts)
//	}
